...
parser = argparse.ArgumentParser(description='Testing_ACM')
parser.add_argument('--gpu_ids',default='0', type=str,help='gpu_ids: e.g. 0  0,1,2  0,2')
parser.add_argument('--which_epoch',default='last', type=str, help='0,1,2,3...or last')
parser.add_argument('--test_dir',default='../data/test_data',type=str, help='./test_data')
parser.add_argument('--name', default='twj', type=str, help='save model path')
parser.add_argument('--pool', default='gem', type=str, help='avg|max')
...
image_datasets['query_street'] = CustomData160k_drone( os.path.join(data_dir,'workshop_query_street') ,data_transforms, query_name = '../data/test_data/workshop_query_street/query_street_name.txt')
...
if __name__ == "__main__":
    ...
    save_filename = 'answer/answer.txt'
